...
namespace Dynastream.Fit
{
    ...
    public class WorkoutStepMesg : Mesg
    {
        ...
        static class TargetValueSubfield
        {
            ...
            public static ushort Subfields = 10;
            public static ushort Active = Fit.SubfieldIndexActiveSubfield;
            public static ushort MainField = Fit.SubfieldIndexMainField;
        }
        ...
        {
            return (uint?)GetFieldValue(4, 0, TargetValueSubfield.TargetSpeedZone);
        }
        ...
        {
            return (uint?)GetFieldValue(4, 0, TargetValueSubfield.TargetCadenceZone);
        }
