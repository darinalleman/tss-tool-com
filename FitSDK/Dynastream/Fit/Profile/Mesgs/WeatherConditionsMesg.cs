...
namespace Dynastream.Fit
{
    ...
    public class WeatherConditionsMesg : Mesg
    {
        ...
        {
            return (sbyte?)GetFieldValue(1, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (sbyte?)GetFieldValue(6, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return TimestampToDateTime((uint?)GetFieldValue(9, 0, Fit.SubfieldIndexMainField));
        }
        ...
        {
            return (int?)GetFieldValue(10, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (int?)GetFieldValue(11, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (sbyte?)GetFieldValue(14, 0, Fit.SubfieldIndexMainField);
        }
