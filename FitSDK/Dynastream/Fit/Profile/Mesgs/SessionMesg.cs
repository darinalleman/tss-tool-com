...
namespace Dynastream.Fit
{
    ...
    public class SessionMesg : Mesg
    {
        ...
        {
            return (float?)GetFieldValue(132, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (float?)GetFieldValue(133, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (float?)GetFieldValue(134, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (float?)GetFieldValue(137, 0, Fit.SubfieldIndexMainField);
        }
