...
namespace Dynastream.Fit
{
    ...
    public class RecordMesg : Mesg
    {
        ...
        {
            return (float?)GetFieldValue(83, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (float?)GetFieldValue(84, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (float?)GetFieldValue(85, 0, Fit.SubfieldIndexMainField);
        }
