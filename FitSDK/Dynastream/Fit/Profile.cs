...
namespace Dynastream.Fit
{
    ...
    public static class Profile
    {
        ...
        private static Mesg CreateAccelerometerDataMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("CompressedCalibratedAccelX", 8, 132, 1, 0, "mG", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("CompressedCalibratedAccelY", 9, 132, 1, 0, "mG", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("CompressedCalibratedAccelZ", 10, 132, 1, 0, "mG", false, Type.Uint16));
            fieldIndex++;
