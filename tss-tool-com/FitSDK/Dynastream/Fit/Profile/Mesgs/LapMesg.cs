...
namespace Dynastream.Fit
{
    ...
    public class LapMesg : Mesg
    {
        ...
        {
            return (float?)GetFieldValue(118, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (float?)GetFieldValue(119, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (float?)GetFieldValue(120, 0, Fit.SubfieldIndexMainField);
        }
