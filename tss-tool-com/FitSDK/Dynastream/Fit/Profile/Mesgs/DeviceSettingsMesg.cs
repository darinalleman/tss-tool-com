...
namespace Dynastream.Fit
{
    ...
    public class DeviceSettingsMesg : Mesg
    {
        ...
        {
            return TimestampToDateTime((uint?)GetFieldValue(39, 0, Fit.SubfieldIndexMainField));
        }
        ...
        {
            return (ushort?)GetFieldValue(40, index, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (ushort?)GetFieldValue(57, index, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (ushort?)GetFieldValue(58, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (ushort?)GetFieldValue(59, 0, Fit.SubfieldIndexMainField);
        }
        ...
        {
            return (uint?)GetFieldValue(90, 0, Fit.SubfieldIndexMainField);
        }
